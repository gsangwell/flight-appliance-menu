# Contributing to Flight Appliance Menu

:+1::tada: Thanks for taking the time to contribute! :tada::+1:

You want to contribute to Flight Appliance Menu? Welcome! Please read this
...
You can help Flight Appliance Menu by helping others who use it and need support.
...
If you find a bug - behaviour of Flight Appliance Menu code or documentation
...
[GitHub issue tracker for Flight Appliance Menu](https://github.com/openflighthpc/openflight-boilerplate/issues/new)
to report the issue.
...
We want to improve the quality of Flight Appliance Menu and good bug reports are
...
Flight Appliance Menu is Open Source and comes without warranty.
...
Flight Appliance Menu in order to fix bugs or to implement new features.
...
2. **Not all proposed contributions can be accepted**. Some features
   ...
   the overall direction of Flight Appliance Menu and really improve it. The more
...
applied to Flight Appliance Menu itself.
...
8. Wait for our code review and approval, possibly enhancing your
   change on request.
    - Note that the Flight Appliance Menu developers also have their regular
